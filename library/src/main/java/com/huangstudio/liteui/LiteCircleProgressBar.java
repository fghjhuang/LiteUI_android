...
public class LiteCircleProgressBar extends View
{
    ...
    public LiteCircleProgressBar(Context context)
    {
        super(context, null);
        initView();
    }

    public LiteCircleProgressBar(Context context, AttributeSet attrs)
    {
    ...
    public LiteCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LiteCircleProgressBar);

        int color1 = a.getColor(R.styleable.LiteCircleProgressBar_front_color1, Color.GREEN);
        int color2 = a.getColor(R.styleable.LiteCircleProgressBar_front_color2, color1);
        int color3 = a.getColor(R.styleable.LiteCircleProgressBar_front_color3, color1);

        bgArcColor = a.getColor(R.styleable.LiteCircleProgressBar_bg_arc_color, 0xff111111);
        longDegreeColor = a.getColor(R.styleable.LiteCircleProgressBar_degree_color, 0xff111111);
        shortDegreeColor = a.getColor(R.styleable.LiteCircleProgressBar_degree_color, 0xff111111);
        hintColor = a.getColor(R.styleable.LiteCircleProgressBar_hint_color, 0xff676767);

        colors = new int[]{color1, color2, color3, color3};

        sweepAngle = a.getInteger(R.styleable.LiteCircleProgressBar_sweep_angle, 270);
        bgArcWidth = a.getDimension(R.styleable.LiteCircleProgressBar_bg_arc_width, dipToPx(10));
        progressWidth = a.getDimension(R.styleable.LiteCircleProgressBar_front_width, dipToPx(10));

        seekEnable = a.getBoolean(R.styleable.LiteCircleProgressBar_is_seek_enable, false);
        isNeedTitle = a.getBoolean(R.styleable.LiteCircleProgressBar_is_need_title, false);
        isNeedContent = a.getBoolean(R.styleable.LiteCircleProgressBar_is_need_content, false);
        isNeedUnit = a.getBoolean(R.styleable.LiteCircleProgressBar_is_need_unit, false);
        isNeedDial = a.getBoolean(R.styleable.LiteCircleProgressBar_is_need_dial, false);

        hintString = a.getString(R.styleable.LiteCircleProgressBar_string_unit);
        titleString = a.getString(R.styleable.LiteCircleProgressBar_string_title);

        currentValues = a.getFloat(R.styleable.LiteCircleProgressBar_current_value, 0);
        maxValues = a.getFloat(R.styleable.LiteCircleProgressBar_max_value, 60);
...
//        curSpeedPaint.setTextSize(curSpeedSize);
    ...
    private void onStopTrackingTouch(MotionEvent event)
    {
        ...
        if(listener != null)
        {
            listener.onStopTrackingTouch(this,progress);
        }
    }
...
//        angle -= mStartAngle;
    ...
    public interface OnSeekArcChangeListener
    {
         ...
         *                 {@link LiteCircleProgressBar#setMaxValues(float)} . (The default value for
         *                 max is 100.)
         * @param fromUser True if the progress change was initiated by the user.
         */
        void onProgressChanged(LiteCircleProgressBar seekArc, int progress, boolean fromUser);
         ...
         */
        void onStartTrackingTouch(LiteCircleProgressBar seekArc);
         ...
         * @param seekArc The SeekArc in which the touch gesture began
         */
        void onStopTrackingTouch(LiteCircleProgressBar seekArc, int progress);
    }
}
