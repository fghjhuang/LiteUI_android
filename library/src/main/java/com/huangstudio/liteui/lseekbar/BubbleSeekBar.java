package com.huangstudio.liteui.lseekbar;
...
import com.huangstudio.liteui.R;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;
import java.math.BigDecimal;

import static com.huangstudio.liteui.lseekbar.BubbleUtils.dp2px;
import static com.huangstudio.liteui.lseekbar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    static final int SIDES = 0, BOTTOM_SIDES = 1, BELOW_SECTION_MARK = 2;
...
//    }
    ...
    private int default_BubbleSeekBar_bsb_track_color = 0xff607D8B; //mTrackColor
    private int default_BubbleSeekBar_bsb_second_track_color = 0xffFF9800;//mSecondTrackColor
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color, default_BubbleSeekBar_bsb_track_color);
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                default_BubbleSeekBar_bsb_second_track_color);
    ...
    private void initSectionTextArray() {
        boolean ifBelowSection = mSectionTextPosition == BELOW_SECTION_MARK;// mSectionTextPosition == TextPosition.BELOW_SECTION_MARK;
