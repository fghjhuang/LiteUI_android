...
public class BubbleConfigBuilder {
  ...
  //  @BubbleSeekBar.TextPosition
    ...
    public BubbleConfigBuilder trackColor( int color) {
        this.trackColor = color;
        this.sectionTextColor = color;
        return this;
    }

    public BubbleConfigBuilder secondTrackColor( int color) {
    ...
    public BubbleConfigBuilder thumbColor( int color) {
        this.thumbColor = color;
        return this;
    }

    public BubbleConfigBuilder sectionCount( int count) {
    ...
    public BubbleConfigBuilder sectionTextColor( int color) {
        this.sectionTextColor = color;
        return this;
    }
    ...
    public BubbleConfigBuilder sectionTextInterval( int interval) {
    ...
    public BubbleConfigBuilder thumbTextColor( int color) {
    ...
    public BubbleConfigBuilder bubbleColor( int color) {
        this.bubbleColor = color;
        return this;
    }
    ...
    public BubbleConfigBuilder bubbleTextColor( int color) {
